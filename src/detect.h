...
std::pair<std::array<float, 4>, float> get_data(pybind11::array_t<uint8_t>& data, float prob_threshold = PROB_THRESHOLD);
std::array<float, 2> get_pos(pybind11::array_t<uint8_t>& data, float prob_threshold = PROB_THRESHOLD);